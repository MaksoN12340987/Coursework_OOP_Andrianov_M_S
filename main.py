...
def main():
    ...
    # item_hh = HH("https://api.hh.ru/vacancies")
    # vacancies_hh = item_hh.load_vacancies("Python")

    save_object = Saver("data/vacancies_hh.json")
    # save_object.save_json(vacancies_hh)
    print(save_object.getting_data_from_file())
